...
<head>
    ...
    <title>Login - Kelompok Keahlian</title>
    <style>
        body {
                    ...
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        ...
                        <div class="card card-primary ">
                            <div class="card-header">
                                <h4>Login Kelompok Keahlian</h4>
                            </div>
                            <div class="card-body">
                                <form action="post-login-kk" method="POST">
                                    {{ csrf_field() }}
                            ...
                            <div class=" mb-3 text-muted text-center">
                                Don't have an account? <a href="dosen-register">Register!</a>
                            </div>

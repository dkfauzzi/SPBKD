                    ...
                    <div class="card border border-2 justify-content-center ">
                        <div class="card-body table-responsive">
                            <div class="row d-flex justify-content-center" style="margin-left: px;">
                                ...
                                <canvas id="dosen_SK1" width="300" height="300"></canvas>
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        ...
                                        fetch('/d-chart/data-sk')
                                            ...
                                            var ctxBar = document.getElementById('dosen_SK1').getContext('2d');
                    ...
                    <div class="card border border-2">
                        <div class="card-body table-responsive">
                            <div class="row d-flex justify-content-center" style="margin-left: px;">
                                ...
                                <canvas id="dosen_SKS1" width="400" height="300"></canvas>
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        // Fetch data for all charts from the server using AJAX
                                        fetch('/d-chart/data-sks')
                                            ...
                                            var ctxProdi = document.getElementById('dosen_SKS1').getContext('2d');
            ...
            <div class="row ">
                <div class="col">
                    <div class="card border border-2">
                        ...
                        <canvas id="prodi_SK_semester1" width="400" height="300"></canvas>
                        ...
                        <script>
                            document.addEventListener("DOMContentLoaded", function () {
                                ...
                                function fetchData(year) {
                                    fetch('/d-chart/data-sk-pie-chart/' + year)
                                        .then(response => response.json())
                                        .then(data => {
                                ...
                                function updateChart(skData) {
                                    var canvasElement = document.getElementById('prodi_SK_semester1');
                    ...
                    <div class="card border border-2">
                        <div class="card-body table-responsive">
                            <div class="row d-flex justify-content-center">
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", function () {
                                        fetch('/d-chart/data-sk-kk-semester')
                                            .then(response => response.json())
                                            .then(data => {
                            ...
                            <div class="row d-flex justify-content-center">
                                ...
                                <script defer>
                                    document.addEventListener("DOMContentLoaded", function () {
                                        ...
                                        // Function to fetch data based on the selected year
                                        function fetchData(year) {
                                            fetch('/d-chart/data-sk-quarterly-line-chart/' + year)
                                                .then(response => response.json())
                                                .then(data => {
                                                    // Update the chart with the new data
